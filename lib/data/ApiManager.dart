...
import 'package:ecommerce_app/data/model/responses/auth_response/auth_response/auth_response.dart';
...
class ApiManager {
  ...
  Future<Result<List<SubCategoryDto>?>> getSubCategories(
    ...
    try {
      var response =
          await dio.get("$subCategoriesEndpoint$categoryId/subcategories");
  ...
  Future<Result<List<ProductDto>?>> getProducts(
    ...
    try {
      ...
      var response = await dio.get(productsEndpoint, queryParameters: params);
